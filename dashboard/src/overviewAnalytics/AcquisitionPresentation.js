...
export default class AcquisitionPresentation extends React.Component {
                ...
                <Overlay isLoading={this.props.isLoading}>
                    <BPanel className="p-0" style={{ minHeight: "260px" }}>
                        <div style={{ textAlign: "center", paddingTop: 41, paddingBottom: 41 }} >
                            <img src='/imgs/common/piStats/overviewScreen/Acquisition.png' alt=''
                            ...
                            <div className="smallFont mobileBlock" style={{ fontSize: "13px" }}>
                                <ModalPresentation
                                    ...
                                    count={this.props.acquisitionViews}
                                    graphData={this.props.acquisitionGraphData}
                                    keys={this.props.acquisitionGraphKeys}
                                    title="Acquisition" image="/imgs/common/piStats/overviewScreen/Acquisition.png" />
                            </div>
                            <div className="bigFont WhiteColor" style={{ fontSize: "26px" }}>
                                {this.props.acquisitionViews > 0 ? numeral(Math.floor(this.props.acquisitionViews)).format('0.00a') : "No Data"}
                            </div>
                        </div>
                    </BPanel>
                </Overlay>
