...
function categoryAnalyticsDetailViewData(state = {isLoading:true}, action) {
    switch (action.type) {
        case "CATEGORY_ANALYTICS_DETAIL_VIEW_DATA_UPDATE":
            return Object.assign({}, state, {
                pageviews:action.categoryDetailData.pageviews,
                publishedViews:action.categoryDetailData.publishedViews,
                dualAreaGraphData: getPublishedVsPageviews(action.categoryDetailData.pageviews,action.categoryDetailData.publishedViews),
                authorPieData:transformForPieChart(action.categoryDetailData.publishedByAuthor),
                typePieData:transformForPieChart(action.categoryDetailData.publishedByType),
                contentTableData: action.categoryDetailData.contentList,
                isLoading: false,
                downloadTableData: prepareData(action.categoryDetailData.contentList)
            });
            break;
        case "CATEGORY_ANALYTICS_DETAIL_VIEW_FETCH":
            return Object.assign({}, state, {
                isLoading: true
            });
            break;
        case "CATEGORY_ANALYTICS_DETAIL_VIEW_FETCH_FAILED":
            return Object.assign({}, state, {
                isLoading: false
            });
            break;
